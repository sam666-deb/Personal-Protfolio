          ...
          <div>
            ...
            <div className="mt-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white dark:bg-slate-800 rounded-lg px-5 py-3 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 shadow-md dark:shadow-none dark:ring-1 dark:ring-slate-700 hover:shadow-lg transition-all duration-200 font-medium"
              >
